...
В поиске сверху показываются подходящие авторы; в расширенном — год издания и дата добавления. «ё» и «е», «Имя Фамилия» и «Фамилия Имя» в поиске не мешают, выдача постраничная. Авторы и серии — по буквам; в жанрах — «Популярные», «Новинки», «По алфавиту»; на странице автора — его серии. Читалка: страницы (свайп вбок или вниз) или лента, шрифт, выравнивание, полный экран, прогресс. На карточках при входе виден процент прочитанного. Если в FB2 нет обложки — заглушка с названием. Архивы могут лежать в нескольких папках. Языки каталога задаёт администратор (по умолчанию русский; можно несколько или все). Вход — с ролями читатель и админ или без пароля.
