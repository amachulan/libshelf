...
- поиск по **автору, названию и серии** сразу; расширенный — автор, **год издания** и **год добавления** в каталог; у автора — список **серий**; **ё/е** и порядок имени не мешают; выдача по релевантности, с **пагинацией**
